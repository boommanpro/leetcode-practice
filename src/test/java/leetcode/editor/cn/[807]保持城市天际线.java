...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertEquals(35, solution.maxIncreaseKeepingSkyline(grid1));
            ...
            Assert.assertEquals(0, solution.maxIncreaseKeepingSkyline(grid2));
