...
//
//
// Related Topics贪心 | 树 | 数组 | 动态规划 | 二叉树
//
...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertEquals(6, solution.minIncrements(7, new int[]{1, 5, 2, 2, 3, 3, 1}));
            Assert.assertEquals(0, solution.minIncrements(3, new int[]{5, 3, 3}));
        }
