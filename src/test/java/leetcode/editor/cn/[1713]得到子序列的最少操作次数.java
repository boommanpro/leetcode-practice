...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertEquals(2, solution.minOperations(new int[]{5, 1, 3}, new int[]{9, 4, 2, 3, 4}));
            Assert.assertEquals(3, solution.minOperations(new int[]{6, 4, 8, 1, 3, 2}, new int[]{4, 7, 6, 2, 3, 8, 6, 1}));
        }
    }
}