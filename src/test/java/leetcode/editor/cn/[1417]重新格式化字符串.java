...
// Related Topics 字符串 👍 77 👎 0
    ...
    class Solution {
        ...
        public String reformat(String s) {
            ...
            return reMerge(digit, letter);
        }

        private String reMerge(List<Character> a, List<Character> b) {
            if (a.size() < b.size()) {
                return reMerge(b, a);
            }
...
//            Assert.assertEquals("0b1c2", solution.reformat("0b1c2"));
