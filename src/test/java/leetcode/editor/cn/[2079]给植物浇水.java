...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertEquals(14, solution.wateringPlants(new int[]{2, 2, 3, 3}, 5));
            Assert.assertEquals(30, solution.wateringPlants(new int[]{1, 1, 1, 4, 2, 3}, 4));
            Assert.assertEquals(49, solution.wateringPlants(new int[]{7, 7, 7, 7, 7, 7, 7}, 8));
        }
