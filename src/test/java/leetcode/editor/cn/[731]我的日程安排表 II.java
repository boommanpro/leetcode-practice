...
// 
// Related Topics 设计 线段树 二分查找 有序集合 👍 184 👎 0
...
//Do some Test
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertTrue(MyCalendar.book(50, 60)); // returns true
            Assert.assertTrue(MyCalendar.book(10, 40)); // returns true
            Assert.assertFalse(MyCalendar.book(5, 15)); // returns false
            Assert.assertTrue(MyCalendar.book(5, 10)); // returns true
            Assert.assertTrue(MyCalendar.book(25, 55)); // returns true
