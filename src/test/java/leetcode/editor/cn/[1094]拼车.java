...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertFalse(solution.carPooling(new int[][]{{2, 1, 5}, {3, 3, 7}}, 4));
            Assert.assertTrue(solution.carPooling(new int[][]{{2, 1, 5}, {3, 3, 7}}, 5));
            Assert.assertTrue(solution.carPooling(new int[][]{{2, 1, 5}, {3, 5, 7}}, 3));
            Assert.assertTrue(solution.carPooling(new int[][]{{3, 2, 7}, {3, 7, 9}, {8, 3, 9}}, 11));
        }
    }
}