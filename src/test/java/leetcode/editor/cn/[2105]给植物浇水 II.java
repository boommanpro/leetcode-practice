...
//
    ...
    class Solution {
        public int minimumRefill(int[] plants, int capacityA, int capacityB) {
            ...
            if (n % 2 != 0) {
                if (plants[i] > currA && plants[i] > currB) {
                    ans++;
                }
            }
            return ans;
...
//            Assert.assertEquals(1, solution.minimumRefill(new int[]{2, 2, 3, 3}, 5, 5));
//            Assert.assertEquals(2, solution.minimumRefill(new int[]{2, 2, 3, 3}, 3, 5));
            Assert.assertEquals(0, solution.minimumRefill(new int[]{5}, 10, 8));
        }
