...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertEquals(16,solution.minimalSteps(new String[]{"S#O", "M..", "M.T"}));
            Assert.assertEquals(-1,solution.minimalSteps(new String[]{"S#O", "M.#", "M.T"}));
            Assert.assertEquals(17,solution.minimalSteps(new String[]{"S#O", "M.T", "M.."}));
        }
    }
}