...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertEquals(2, solution.firstDayBeenInAllRooms(new int[]{0, 0}));
            Assert.assertEquals(6, solution.firstDayBeenInAllRooms(new int[]{0, 0, 2}));
            Assert.assertEquals(6, solution.firstDayBeenInAllRooms(new int[]{0, 1, 2, 0}));
        }
    }
}
