...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static class TestClass {
        ...
        public void defaultSolutionTest() {
            ...
            Assert.assertEquals(0.50000, solution.champagneTower(2, 1, 1), 0.00001);
            Assert.assertEquals(1.00000, solution.champagneTower(100000009, 33, 17), 0.00001);
        }
